...
deploy-sepolia :
	@forge script scripts/DeployRaffle.s.sol:DeployRaffle --rpc-url $(SEPOLIA_RPC_URL) --account sepoliaAccount --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv